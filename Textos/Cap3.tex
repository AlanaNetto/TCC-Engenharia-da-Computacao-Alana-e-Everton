...
\section{Análise da Arquitetura do Sistema}
    ...
    O servidor, programado em Python, utilizará um serviço chamado Cloud Foundry. O banco de dados, não relacional, utilizará o serviço IBM Cloudant.

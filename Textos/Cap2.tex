...
O objetivo desse capítulo é fornecer uma base para a leitura do texto apresentado nessa monografia em que são estudadas as tecnologias assistivas, a visão computacional e as formas de identificação de objetos em imagem.
